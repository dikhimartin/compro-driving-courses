...
<!-- newsletter part -->
<div class="bg-primary dlab-newsletter wow fadeIn" data-wow-duration="2s" data-wow-delay="0.2s">
                ...
                <div class="widget recent-posts-entry">
                    ...
                    <div class="widget-post-bx">
                        <div class="widget-post clearfix">
                            ...
                            <div class="dlab-post-info">
                                <div class="dlab-post-header">
                                    <h6 class="post-title text-uppercase"><a href="blog-single.html">Autocare renovation</a></h6>
                                </div>
                        ...
                        <div class="widget-post clearfix">
                            ...
                            <div class="dlab-post-info">
                                <div class="dlab-post-header">
                                    <h6 class="post-title text-uppercase"><a href="blog-single.html">Auto reforms</a></h6>
                                </div>
                                <div class="dlab-post-meta">
                                    <ul>
                                        <li class="post-author">By <a href="#">Admin</a></li>
                        ...
                        <div class="widget-post clearfix">
                            ...
                            <div class="dlab-post-info">
                                <div class="dlab-post-header">
                                    <h6 class="post-title  text-uppercase"><a href="blog-single.html">Autocare industries</a></h6>
                                </div>
                                <div class="dlab-post-meta">
                                    <ul>
                                        <li class="post-author">By <a href="#">Admin</a></li>
