...
assets/images
		opt.c.closest('.assets/imagesullwidth_wrapper_tp_banner').find('.tp-fullwidth-forcer').css(si);
	...
	leaveViewPort : function(opt) {		
		...
		if (opt.playingvideos != undefined && opt.playingvideos.length>0) { 
			...
			opt.lasassets/imagesdvideos = jQuery.extend(true,[],opt.playingvideos);
assets/images
...
var getScriptLocation = function(a) {
	...
	var srcexp = new RegExp("themepunch.revolution.min.js","gi"),
		...
		ret = "";
assets/images
	jQuery(assets/imagest").each(function() {
...
var setCurWinRanassets/imagesunction(opt,vis) {		
